...
V obecném základu najdeme základní presenter(\uv{BasePresenter}), od kterého jsou všechny ostatní poděděné, presenter zajištující přihlašování(\uv{AuthPresenter}) a presenter na spracování chybových hlášek (\uv{ErrorPresenter}).
