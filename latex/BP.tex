...
\abstractCS{
Bakal{\' a}{\v r}sk{\' a} pr{\' a}ce p{\v r}edstavuje re{\v s}er{\v s}i dostupn{\' y}ch n{\'a}strojů pro vy{\' u}čtov{\' a}n{\' i} kr{\' a}tkodob{\' y}ch akc{\' i}, n{\' a}sledn{\v e} anal{\' y}zu a v{\' y}voj nov{\' e} aplikace. Je zde pops{\' a}n v{\' y}voj knihovny pro komunikaci se syst{\' e}mem SkautIS.}
...
Pro formátování HTML výstupu a některé JavaScriptové komponenty bude použit \uv{Twitter Bootstrap}\cite{twBootstrap}, což je mladý projekt od vývojářů z firmy Twitter. Ostatní JavaScriptové komponenty a události budou využívat populární knihovnu jQuery\cite{jquery}.
