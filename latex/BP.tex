...
Středisko Blaník využívá vlastní systém naprogramovaný v php skládající se ze tří základních částí. První část LTIO (\url{http://lab.blanik.info/ltoi/}) - Letní tábor a obnova inventáře - slouží pro vyúčtování táborů. Zadávají se zde odděleně informace o táboře, příjmy, výdaje, účastníci a cestovní příkazy. Veškeré informace je možné nechat vyexportovat do formátu csv nebo rtf.
...
Výhody systému:
\begin{itemize}
	\item možnost nastavit počet dnů účasti u jednotlivých účastníků táborav (LTIO)
	\item automatická kontrola vnitřních vztahů mezi účastníky a příjmy (LTIO)
	...
	\item možnost vyplnit cestovní příkaz (LTIO)
	\item možnost předat vyučtování akce hospodáři (LTIO)
\end{itemize}


Nevýhody systému:
\begin{itemize}
	\item malý počet účetních kategorií (LTIO)
	\item není propojen se systémem SkautIS
...
\begin{itemize}
	...
	\item umí příjmout údaje z paragonu a ty pak spravovat
...
\begin{itemize}
	...
	\item aplikace funguje na PHP 5 >= 5.2.0, Mysql 5
\end{itemize}
