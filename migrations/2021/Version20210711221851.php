 ...
 */
final class Version20210711221851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tc_contracts CHANGE unit_representative unit_representative VARCHAR(64) NOT NULL');
    }
