...
class BaseTable {
    ...
    const TABLE_CATEGORY = 'ac_category';
    //const TABLE_ROLES ="ucetnictvi_roles";
    //const TABLE_ACTIONS ="ucetnictvi_vypravy";
    //const TABLE_VYPRAVYUSERS ="ucetnictvi_vypravyUsers";
    //const TABLE_VYPRAVYVIEW ="ucetnictvi_vypravyView";
    //const TABLE_UNITS ="ucetnictvi_units";
    //const TABLE_UNITSUSERS ="ucetnictvi_unitsUsers";
}
