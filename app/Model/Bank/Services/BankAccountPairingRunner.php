...
final class BankAccountPairingRunner
{
     ...
     * @param  callable(int, array<mixed>): (BankAccount|null)                                               $bankAccountResolver
     * @param  callable(array<mixed>): list<PairingCandidate>                                                $scopeCandidatesResolver
     * @param  callable(array<mixed>): ChronosDate                                                           $pairSinceResolver
     * @param  callable(BankAccount, ChronosDate, ChronosDate): list<\App\Model\Bank\Entity\BankTransaction> $transactionsLoader
     * @param  callable(BankAccount, array<mixed>): bool|null                                                $canPairResolver
