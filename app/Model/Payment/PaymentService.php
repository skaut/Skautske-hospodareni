...
use App\Model\Event\Exception\CampInvitationNotFound;
...
class PaymentService
{
    ...
    public function updateGroup(
        ...
        if ($bankAccountId !== $group->getBankAccountId()) {
            $this->variableSymbolCollisionChecker->assertGroupCanUseBankAccount($group, $bankAccount);
        }
    ...
    public function generateVs(int $gid): int
    {
        ...
        foreach ($payments as $payment) {
            $this->variableSymbolCollisionChecker->assertUniqueForPayment($group, $payment->getId(), $nextVariableSymbol);
