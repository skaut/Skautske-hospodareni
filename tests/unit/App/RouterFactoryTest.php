...
final class RouterFactoryTest extends Unit
{
    ...
    public function provideCanonicalPaymentRoutesForConstruction(): array
    {
        return [
            ...
            [['presenter' => 'Events:Event', 'action' => 'printAll', 'aid' => 42], '/akce/42/print-all'],
            ...
            [['presenter' => 'Camps:Detail', 'action' => 'report', 'aid' => 42], '/tabory/42/report'],
    ...
    public function provideCanonicalPaymentRoutesForMatching(): array
    {
        return [
            ...
            ['/tabory/42/report', ['presenter' => 'Camps:Detail', 'action' => 'report', 'aid' => 42]],
            ...
            ['/akce/42/print-all', ['presenter' => 'Events:Event', 'action' => 'printAll', 'aid' => 42]],
