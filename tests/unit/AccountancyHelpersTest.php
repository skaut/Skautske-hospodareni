...
class AccountancyHelpersTest extends Unit
{
    public function testDateRangeOnlyOneArgument(): void
    {
        ...
        AccountancyHelpers::dateRange([new ChronosDate('2019-08-01')]);
    }
    ...
    public function testDateRangeToMuchArguments(): void
    {
        ...
        AccountancyHelpers::dateRange([
            new ChronosDate('2019-08-01'),
            new ChronosDate('2019-08-02'),
            new ChronosDate('2019-08-03'),
        ]);
    }
    ...
    {
        return [
            [new ChronosDate('2019-08-01'), '1. 8. 2019'],
            [new ChronosDate('2019-08-02'), '1. - 2. 8. 2019'],
            [new ChronosDate('2019-09-01'), '1. 8. - 1. 9. 2019'],
            [new ChronosDate('2020-01-01'), '1. 8. 2019 - 1. 1. 2020'],
        ];
    }

    /** @dataProvider getDateRanges */
    public function testDateRange(ChronosDate $end, string $expectedResult): void
    {
